...
const ManagerOperationsViewEmpAtt = ({ userRole }) => { // Pass userRole as a prop
    ...
    return (
        ...
        <div className='manmain-attendance-container' style={{ textAlign: 'center', marginTop: '50px' }}>
            <h2 className='manmain-attendance-title'>Manage Employee Attendance</h2>
            <Link to="/manageroperations/employee_attendance/viz">
                    ...
                    {attendanceData.length > 0 ? (
                        attendanceData.map(record => (
                            <tr key={record.Attendance_ID}>
                                ...
                                <td>
                                <Link to={`/manageroperations/employee_attendance/edit/${record.Attendance_ID}`}>
