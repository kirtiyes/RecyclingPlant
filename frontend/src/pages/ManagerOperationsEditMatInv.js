...
import '../styles/ManMainEditMatInv.css'
...
const ManagerOperationsEditMatInv = ({ userRole }) => { // Accept userRole as a prop
    ...
    return (
        <div className='edit-manmainmatinv-wrapper'>
        <div className='edit-manmainmatinv-container' style={{ textAlign: 'center', marginTop: '50px' }}>
            <h2>Edit Material</h2>
